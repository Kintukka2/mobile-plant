...
window.Onboard = (function () {
  ...
  function stepLoc() {
    return '<h2 class="ob-q">Can I use your location?</h2>' +
      '<p class="ob-hint" style="margin-top:0">For a local forecast, so I can offer to stretch or shorten watering before a wet or dry spell. It stays on this device.</p>' +
